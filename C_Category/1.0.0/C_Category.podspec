...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/SLModulizationDemo/C_Category"
  ...
  s.source       = { :git => "https://github.com/SLModulizationDemo/C_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "C_Category/C_Category/**/*.{h,m,swift}"
